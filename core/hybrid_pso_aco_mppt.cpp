/*
HybridPSOACO-Pinnacle — PSO + ACO Fusion Global MPPT
MercySolar Ultramasterpiece — Jan 18 2026

Hybrid PSO-ACO for partial shading GMPPT:
- Phase 1: ACO — pheromone trails for diversity (20 iterations)
- Phase 2: PSO — velocity refinement for convergence (15 iterations)
- Population: 33 ants/particles (Trinity multiple)
- Evaporation 0.95, Q=100, w=0.729→0.4, c1=c2=1.496
...
void acoPhase() {
  ...
  // Seed PSO positions from ACO bests
  for (int i = 0; i < POP_SIZE; i++) {
    positions[i] = pbest_positions[i];  // Carry ACO diversity
  }
}
